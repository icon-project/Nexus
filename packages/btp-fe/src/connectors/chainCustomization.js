...
export const custom = {
  BSC: {
    tokens: [
      ...
      { symbol: 'sICX', chain: process.env.REACT_APP_CHAIN_BSC_CHAIN_NAME, type: tokenTypes.IRC2 },
      { symbol: 'bnUSD', chain: process.env.REACT_APP_CHAIN_BSC_CHAIN_NAME, type: tokenTypes.IRC2 },
    ],
  },
};
