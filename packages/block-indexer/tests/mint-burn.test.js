...
const burnTxResult = {
  ...
  logsBloom: '0x000000000000800000000000000000000001000...'
};
...
test('should return mint event from tx result', async () => {
  ...
  expect(event).toMatchObject({
    tokenName: 'DEV',
    tokenId: '0x08f7ce30203eb1ff1d26492c94d9ab04d63f4e54f1f9e677e8d4a0d6daaab2dd',
    tokenValue: '0.00000000000003168000',
